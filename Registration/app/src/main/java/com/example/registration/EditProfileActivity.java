            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> taskUri) {
                    if (taskUri.isSuccessful()) {
                        ...
                        if (progressDialog.isShowing() && !(EditProfileActivity.this.isFinishing() || EditProfileActivity.this.isDestroyed())) {
                        ...
                        Toast.makeText(EditProfileActivity.this, "Error: " + taskUri.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
